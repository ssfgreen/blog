  ...
  return (
    <>
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div
          className="h-full bg-[url('https://res.cloudinary.com/samsfgreen/image/upload/v1673284167/bluegradient_ir7hrz.png')] bg-top bg-no-repeat opacity-[0.3] will-change-transform"
          style={{
