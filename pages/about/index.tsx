      ...
      <p>After graduating I contracted briefly as a software engineer building products with Machine Learning for <a className="text-grey-dark" href="https://www.proquoai.com/"><i>ProQuo AI.</i></a></p>
          ...
          <EmojiSectionWrapper>
            ...
            <p>
              ...
              on their Program Team. It was working at EF with technical
              founders that inspired me to study Computer Science.
            </p>
          </EmojiSectionWrapper>
          <EmojiSectionWrapper>
            <p>🏡</p>
          ...
          <EmojiSectionWrapper>
            ...
            <p>
              ...
              . Here I also ran design lectures featuring industry giants such
              as{" "}
              <a
                className="text-grey-dark"
                target="_blank"
          ...
          <EmojiSectionWrapper>
            ...
            <p>
              ...
              I'm trying to get outside. I'm a passionate climber and have
              climbed all over Europe. I've even helped a former{" "}
              <a
                target="_blank"
                className="text-grey-dark"
