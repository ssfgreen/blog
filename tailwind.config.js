  ...
  theme: {
    extend: {
      ...
      keyframes: ({ theme }) => ({
        mutation: {
          "0%": {
            background: theme("colors.sky.200 / 3%"),
          },
          "10%": {
            background: theme("colors.sky.200 / 15%"),
            color: theme("colors.sky.200 / 75%"),
          },
          "100%": {
            background: theme("colors.sky.200 / 0%"),
          },
        },
        emoji: {
          "0%": {
      ...
      boxShadow: ({ theme }) => ({
        ...
        "surface-glass": `
          inset 0.25px 1px 0 0 ${theme("colors.sky.200 / 3%")},
        ...
        "surface-elevation-low": `
          inset 0.25px 1px 1px 0 ${theme("colors.sky.200 / 1.5%")}, 
        ...
        "surface-elevation-medium": `
          inset 0.25px 1px 1px 0 ${theme("colors.sky.200 / 3%")},
