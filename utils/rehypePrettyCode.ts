...
const INLINE_BLOCK =
  "whitespace-nowrap border border-sky-200/10 px-1.5 py-px text-[12px] rounded-full bg-white/5 whitespace-nowrap text-sky-300/90";
const INLINE_CODE = "";
...
const HIGHLIGHTED_LINE =
  "!border-l-sky-300/70 bg-sky-200/10 before:!text-white/70";
